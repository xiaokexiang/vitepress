...
Spring Security（简称SS）的用户信息由使用者通过实现框架提供的`UserDetailsService$loadUserByUsername()`接口方法提供。SS还提供了`UserDetails接口`，作为提供用户信息的核心接口。内嵌了`User类`作为`UserDetails`的默认实现。`UserDetailsManager`作为管理用户信息（增删改查）的默认内嵌管理器接口。而`InMemoryUserDetailsManager`则是默认的用户管理器实现。![](https://fnos.leejay.top:9000/images/2025/01/21/472c9c6d-3219-430c-90fc-bfc25e4b78b1.png)
...
![](https://fnos.leejay.top:9000/images/2025/01/21/353871e1-5a67-414c-92bd-c5f5c7b9588a.png)
...
![](https://fnos.leejay.top:9000/images/2025/01/21/5477a188-ecff-4952-8f6e-e8c64eebeee1.png)
